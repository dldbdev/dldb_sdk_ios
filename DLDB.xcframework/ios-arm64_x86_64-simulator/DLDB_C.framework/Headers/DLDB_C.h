...
//! Project version number for DLDB_C.
FOUNDATION_EXPORT double DLDB_CVersionNumber;

//! Project version string for DLDB_C.
FOUNDATION_EXPORT const unsigned char DLDB_CVersionString[];
